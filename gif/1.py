...
def mainFunc() :
    ...
    cho1 = Button(win, image = choice1, anchor = CENTER, command = themechoice)
    cho2 = Button(win, image = choice2, anchor = CENTER)
    cho3 = Button(win, image = choice3, anchor = CENTER)
    cho4 = Button(win, image = choice4, anchor = CENTER)
    cho5 = Button(win, image = choice5, anchor = CENTER)
    cho6 = Button(win, image = choice6, anchor = CENTER)
    cho7 = Button(win, image = choice7, anchor = CENTER)
    cho8 = Button(win, image = choice8, anchor = CENTER)
    cho9 = Button(win, image = choice9, anchor = CENTER)
    cho10 = Button(win, image = choice10, anchor = CENTER)
